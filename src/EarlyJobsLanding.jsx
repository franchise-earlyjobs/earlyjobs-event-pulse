  ...
  const testimonials = [
    {
      ...
      quote:
        "The EarlyJobs franchise opportunity transformed my business. Local hiring has never been easier.",
      rating: 5,
    },
    {
      name: "Priya Sharma",
      ...
      quote:
        "Excellent support from the team and a proven business model that works.",
      rating: 5,
    },
  ];

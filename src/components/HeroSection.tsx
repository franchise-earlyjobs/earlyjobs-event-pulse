    ...
    <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-primary via-primary/90 to-accent">
      ...
      <div className="relative z-10 container mx-auto px-6 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="font-inter text-xl md:text-2xl mb-8 text-white/90 animate-fade-in animation-delay-200">
            Discover What's Next with EarlyJobs.
          </p>
          
          <p className="font-inter text-lg mb-12 text-white/80 animate-fade-in animation-delay-400">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in animation-delay-600">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="border-white text-white hover:bg-white hover:text-primary font-poppins font-semibold px-8 py-4 text-lg"
            >
            ...
            <Button 
              size="lg" 
              variant="secondary" 
              className="bg-white/20 text-white hover:bg-white/30 border-white/30 font-poppins font-semibold px-8 py-4 text-lg"
            >
          ...
          {/* Slide Info */}
          <div className="mt-16 bg-white/10 backdrop-blur-sm rounded-2xl p-6 animate-fade-in animation-delay-800">
